...
Phase 1: Precision@K, Recall@K, NDCG@K, MRR, Hit Rate, Coverage, intra-list
diversity. ECE and Brier arrive with the Bayesian blend in Phase 3.

All metrics operate on per-entity recommendation lists vs. per-entity ground-
truth relevant sets. The harness aggregates across entities via arithmetic
mean; coverage and diversity are aggregated differently and documented per-
metric.
"""
